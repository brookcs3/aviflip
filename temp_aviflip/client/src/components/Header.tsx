        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <div className="flex items-center group cursor-pointer">
                ...
                <span className="ml-2 text-xl font-bold text-gray-900 transition-all duration-300 group-hover:text-primary" style={{ color: siteConfig.primaryColor }}>
                  {siteConfig.logoText}
                </span>
              </div>
            </div>
          ...
          <div className="flex items-center">
            <a 
              ...
              className="text-gray-500 hover:text-primary transition-all duration-300 transform hover:scale-110" 
              target="_blank" 
